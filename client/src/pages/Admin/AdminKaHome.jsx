...
import { GraduationCap, Users, BookUser, UserPlus, ClipboardList, LogOut, Calendar } from 'lucide-react';
    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="bg-gray-50 py-4 text-center mb-8 mt-8">
          <div className="max-w-7xl mx-auto px-4">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Back2Campus Admin</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-10">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg hover:translate-y-1 transition-transform duration-200 relative">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <BookUser size={20} className="text-indigo-700" />
                Department Directory
              </h3>
              <p className="text-gray-600 mb-6">Access and manage alumni listings with sorting and search options.</p>
            ...
            {/* Alumni Meet Management - With border accent */}
            <div className="bg-white rounded-lg p-6 shadow-lg hover:translate-y-1 transition-transform duration-200 relative">
            <div className="absolute top-0 right-0 w-16 h-16 bg-indigo-600 rounded-bl-full opacity-10"></div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <Users size={20} className="text-indigo-700" />
                Alumni Meet Management
              </h3>
              <p className="text-gray-600 mb-6">Oversee planning, registrations, and communications for alumni meet.</p>
              <Link to="/admin-alumni-meet" className="text-white no-underline">
                <button className="bg-indigo-600 text-white py-2 px-4 rounded-md font-medium hover:bg-indigo-700 inline-flex items-center gap-2 transition-colors duration-200 w-full transform hover:scale-[1.02]">
                  Manage Alumni Meet
                </button>
              </Link>
            ...
            {/* Event Management - With border accent */}
            <div className="bg-white rounded-lg p-6 shadow-lg hover:translate-y-1 transition-transform duration-200 relative">
            <div className="absolute top-0 right-0 w-16 h-16 bg-indigo-600 rounded-bl-full opacity-10"></div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
              ...
              <p className="text-gray-600 mb-6">Coordinate and manage event planning, scheduling, and participant engagement.</p>
